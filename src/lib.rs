...
#[derive(Debug)]
pub struct BlockEdgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockEdgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockEdge processing");
    
    let mut processor = BlockEdgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockEdgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockEdgeProcessor::new(false);
